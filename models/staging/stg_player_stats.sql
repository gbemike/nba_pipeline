...
renamed as (
    select
        ...
        -- stats
        --SAFE_CAST(ts_value as decimal) as ts_value,
        ...
        -- SAFE_CAST(ftr_value as decimal) as ftr_value,
        {{ string_to_float('ftr_value') }} as ftr_value,
        SAFE_CAST(ftr_percentile as decimal) as ftr_percentile,
        -- SAFE_CAST(three_par_value as decimal) as three_par_value,
        ...
        -- SAFE_CAST(ctov_value as decimal) as ctov_value,
        {{ string_to_float('ctov_value') }} as ctov_value,
